...
class DepoController extends Controller
{
    ...
    public function depoHome(){
        ...
        return view('depo.welcome',['id'=>$id,'info'=>$user,
            ...
            'contact'=>$contact,'slider'=>$slider,'prodText'=>$producttext,'stText'=>$storetext]);
    }
    ...
    public function product()
    {
        ...
        return view('depo.product',['id' => $id,'info'=>$user,'count'=>$count,'category'=>$category,
            'mar'=>$mar, 'contact'=>$contact, 'prodText'=>$producttext]);
    }
    ...
    public function store()
    {
        ...
        return view('depo.store',['id' => $id,'info'=>$user,'count'=>$count,'product'=>$product,
            'mar'=>$mar, 'contact'=>$contact,'stText'=>$storetext]);
    }
    ...
    public function cart(Request $request)
    {
        ...
        $user = DepoInfo::find($id);
        $ip = $request->ip();
        $order = Order::where('user_id',$user->id)->where('order_status','Pending')
    ...
    public function checkout()
    {
        ...
        'charge'=>$userShipping,'outside'=>$userShippingOutside]);
    }
}
