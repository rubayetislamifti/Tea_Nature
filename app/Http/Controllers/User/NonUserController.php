...
class NonUserController extends Controller
{
    ...
    public function product()
    {
        ...
        $contact = DB::table('contacts')->first();
        $producttext = DB::table('product_pages')->first();
        return view('non-user.product',['category'=>$category,'text'=>$text,'contact'=>$contact,'prodText'=>$producttext]);
    }
    ...
    public function store()
    {
        ...
        $contact = DB::table('contacts')->first();
        $storetext = DB::table('store_pages')->first();
        return view('non-user.store',['product'=>$product,'text'=>$text,'contact'=>$contact,'stText'=>$storetext]);
    }
...
//        dd($cartItem);
    ...
    public function privacy_policy()
    {
        ...
        return view('non-user.privacy-policy',['contact'=>$contact,'privacy'=>$privacy]);
    }
