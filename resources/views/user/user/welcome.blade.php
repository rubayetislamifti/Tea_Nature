...
<div class="container-fluid product py-5 my-5">
    <div class="container py-5">
        ...
        <div class="owl-carousel product-carousel wow " data-wow-delay="0.5s">
            ...
            <a href="{{route('stores',['id'=>$info->id])}}" class="d-block product-item rounded">
...
{{--                        <a href="{{route('cart',['id'=>$info->id])}}" class="btn btn-dark rounded-pill py-2 px-4 m-2 add-to-cart-btn">Add to Cart <i--}}
