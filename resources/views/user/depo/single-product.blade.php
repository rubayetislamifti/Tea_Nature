...
<head>
    ...
    <script>
      ...
      gtag('config', 'G-RLP6WBMWKY', {
        'user_id': '{{$info->id}}'  // Set the user ID
    });
    </script>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="prices">
                    ...
                    <span class="new-price">Per Carton: {{$product->cartoonprice}}৳</span> <!-- New price -->
                </div>
                <form action="{{route('create_order')}}" method="POST">
                    ...
                    <input type="number" id="quantity" name="quantity" class="form-control mb-4" min="1" max="50" value="1">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        gtag('event', 'view_item', {
            ...
            'value': {{$product->cartoonprice}},  // Optional, the value of the product
            'items': [{
                'id': '{{$product->id}}',
                'name': '{{$product->name}}',
                'category': '{{$product->category}}',  // Replace with actual category if available
                'price': {{$product->cartoonprice}},
                
            }],
            'user_id': '{{$info->id}}',
            'user_type': '{{$info->roles}}'// Include the user ID
        });
    });
</script>
