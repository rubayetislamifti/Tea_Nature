        ...
        <div class="page-content">
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Store Pages</li>
                </ol>
            </nav>
            ...
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Store Page</h4>
                            ...
                            <form action="{{ route('store_title_upload') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="id" value="@if(isset($marquee->id)) {{$marquee->id}} @endif">
                                <div class="mb-3">
                                    <label for="name" class="form-label">Text</label>
                                    <input id="number" class="form-control" name="sphone" value="@if(isset($marquee->text)) {{$marquee->text}} @endif" type="text">
                                </div>
