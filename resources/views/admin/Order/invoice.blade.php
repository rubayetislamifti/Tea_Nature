        ...
        <div class="cs-invoice_in" id="download_section">
            <div class="cs-invoice_head cs-type1 cs-mb25">
                ...
                <div class="cs-invoice_right cs-text_right">
                    <div class="cs-logo cs-mb5"><img src="{{asset('invoice/assets/img/logo.png')}}" alt="Logo"></div>
                </div>
            ...
            <div class="cs-invoice_head cs-mb10">
                <div class="cs-invoice_left">
                    ...
                    <p>
                        ...
                        <span style="font-weight: bolder;color: black">@if($roles->roles == 'users'){{$customer->phone}}
                            @else
                                0{{$customer->mobile}}
                            @endif</span> <br>
                ...
                <div class="cs-invoice_right cs-text_right">
                    ...
                    <p>
                        ...
                        @if($customer->payment_method == 'bKash')
                            Transaction: {{$customer->transaction_id}}
                        @else
                        ...
                        <table>
                            ...
                            @foreach($infos as $product)
                                <tr>
                                    ...
                                    <td class="cs-width_4">৳{{$product->price}}</td>
