            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        @if(isset($admins))
                            <div>
                                <form method="GET" action="{{ route('monthly-sales-report',['id'=>$admins->id]) }}" class="form-inline">
                        ...
                        @else
                            <div>
                                <form method="GET" action="{{ route('monthly-sales-report',['id'=>$id]) }}" class="form-inline">
                                    <div class="form-group mr-2">
